  ...
  return (
    <>
      ...
      >
        ...
        <br />
        <img className="ml-1 w-2/6 " src="http://localhost:5173/weChat-group.jpg" alt="weChat-group" />
        <br />
      </InfoPanel>
      ...
      <footer className="mb-1 mt-4 flex w-full items-center justify-center gap-2.5 text-sm ease-in" onClick={(e) => e.currentTarget.blur()}>
        <a href="https://github.com/Kaiyiwing/qwerty-learner" target="_blank" rel="noreferrer" aria-label="GitHub">
