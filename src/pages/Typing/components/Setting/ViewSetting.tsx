      ...
      <ScrollArea.Viewport className="h-full w-full px-3">
        <div className={styles.tabContent}>
          <div className={styles.section}>
            <span className={styles.sectionLabel}>글씨 설정</span>
            <div className={styles.block}>
              <span className={styles.blockLabel}>단어 글씨 크기</span>
            ...
            <div className={styles.block}>
              <span className={styles.blockLabel}>번역 글씨 크기</span>
              <div className="flex h-5 w-full items-center justify-between">
                <Slider.Root
          ...
          <button className="my-btn-primary ml-4 disabled:bg-gray-300" type="button" onClick={onResetFontSize} title="재설정하기">
            재설정하기
          </button>
        </div>
      </ScrollArea.Viewport>
